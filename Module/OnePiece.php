 ...
 * @crawler 小斐 and admin@2d-gate.org
...
'愛德華' => '艾德華',
'紐哥[德特]' => '紐蓋特',
"夏洛特([{$this->_nameDelimiters} 　]*)玲玲" => '夏洛特$1莉莉',
'蓋德' => '海道',
'傑拉基爾' => '喬拉可爾',
'米霍克' => '密佛格',
'多弗拉門戈' => '多佛朗明哥',
...
'拉奧G' => '拉歐G',
'戴林格' => '德林傑',
"賽諾爾([{$this->_nameDelimiters} 　]*)平克" => '粉紅先生',
'馬哈拜斯' => '馬赫拜茲',
'德萊斯羅茲' => '多雷斯羅薩',
'維奧拉' => '碧歐菈',
'紫羅蘭' => '維爾莉特',
'莉貝卡' => '蕾貝卡',
"[裡里]克([{$this->_nameDelimiters} 　]*)多爾鐸" => '利克$1德爾多3世',
'巴爾托羅梅奧' => '巴特洛馬',
'凱文迪修' => '卡文迪許',
'蔡義' => '雜菜',
'布武' => '阿葡',
'海爾丁' => '哈爾汀',
'班克禁區' => '龐克哈薩特',
"凱撒([{$this->_nameDelimiters} 　]*)庫朗" => '凱薩$1克勞恩',
'莫奈' => '莫內',
'維爾高' => '威爾可',
'挪亞' => '諾亞',
'鮫星' => '鯊星',
...
'范德' => '班塔',
'霍迪' => '荷帝',
"伊卡魯斯([{$this->_nameDelimiters} 　]*)姆嘻" => '伊卡洛斯$1穆希',
'梅迦羅' => '梅卡洛',
'夏莉夫人' => '雪莉夫人',
'克爾拉' => '可亞拉',
"加[裡里]([{$this->_nameDelimiters} 　]*)達丹" => '卡莉$1達坦',
'達丹' => '達坦',
"范([{$this->_nameDelimiters} 　]*)貝克曼" => '班$1貝克曼',
"拉奇([{$this->_nameDelimiters} 　]*)路" => '拉奇$1魯',
"旺([{$this->_nameDelimiters} 　]*)奧加" => '范$1歐葛',
"吉扎斯([{$this->_nameDelimiters} 　]*)巴傑斯" => '吉札士$1伯吉斯',
'Dr.Q' => '毒Q',
'希流' => '矢龍',
"聖胡安([{$this->_nameDelimiters} 　]*)惡狼" => '薩方$1烏爾夫',
"阿瓦羅([{$this->_nameDelimiters} 　]*)匹薩羅" => '亞帕羅$1披薩羅',
"巴斯克([{$this->_nameDelimiters} 　]*)喬特" => '巴斯可$1簫特',
"卡特蓮娜([{$this->_nameDelimiters} 　]*)蝶美" => '卡達莉納$1戴彭',
'馬爾高' => '馬可',
'波特夾斯' => '波特卡斯',
'露秀' => '露珠',
'喬茲' => '裘斯',
...
'希爾巴茲' => '席爾巴斯',
'芍奇' => '夏姬',
"巴基爾([{$this->_nameDelimiters} 　]*)霍金斯" => '巴吉魯$1霍金斯',
'德雷克' => '多雷古',
'特拉法爾加' => '托拉法爾加',
'瓦鉄爾' => '瓦特爾',
'江巴爾' => '強帕爾',
'貝寶' => '培波',
'逆戟鯨' => '夏奇',
"打碟人([{$this->_nameDelimiters} 　]*)阿保" => '刮盤人$1亞普',
'基拉' => '奇拉',
"傑麗([{$this->_nameDelimiters} 　]*)邦妮" => '珠寶$1波妮',
'邦妮' => '波妮',
'「匪幫」' => '「流氓」',
"卡彭([{$this->_nameDelimiters} 　]*)班吉" => '卡波涅$1培基',
'維莎利亞' => '維薩利亞',
'巴爾基摩亞' => '巴爾的摩',
'卡瑪巴卡' => '卡馬帕卡',
'海克力斯' => '海格拉斯',
...
'阿斯巴古' => '艾斯巴古',
'巴利' => '包利',
"皮布[裡里]([{$this->_nameDelimiters} 　]*)魯魯" => '畢普利$1露露',
'泰魯斯通' => '戴魯斯通',
'奇姆妮' => '蒂姆妮',
'昆平' => '公貝',
"卡提([{$this->_nameDelimiters} 　]*)佛蘭姆" => '卡迪$1佛拉姆',
'艾尼路' => '艾涅爾',
'皮埃爾' => '皮耶爾',
'馬堅力' => '麥金利',
'柯尼絲' => '柯妮絲',
...
'空扎' => '寇沙',
'鱷魚' => '克洛克達爾',
"達茲([{$this->_nameDelimiters} 　]*)波涅斯" => '達茲$1波涅士',
"盆([{$this->_nameDelimiters} 　]*)歲末" => '馮$1克雷',
'本薩姆' => '班薩姆',
'加爾迪諾' => '賈爾迪諾',
'波拉' => '波菈',
'克洛卡斯' => '可樂可斯',
...
'卡提' => '卡迪',
     ...
     * @ref https://zh.wikipedia.org/wiki/%E6%A8%A1%E5%9D%97:CGroup/OnePiece
     */
    protected function generateMappingFromWikiPage (&$text) {
    ...
    protected function filterConversions (array &$conversions) {
        $nameDelimiters = "{$this->_nameDelimiters} 　";
