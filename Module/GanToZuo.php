...
class GanToZuo extends AbstractModule {
    ...
    private static $mapping = [
        ...
        // replace 幹 - 做
        '幹([完])' => '做$1',
        '(?<![能對])幹([對錯好]?[了點些過])(?![你妳汝我咱俺他她它祂誰其])' => '做$1',
        ...
        '([再在來去想別怎麼會要該]|[你我他她它牠祂誰們]+|[快慢]點|[居竟突忽悻]然|^)幹([啊啦呀吶呢吧]|[的得不出了](?![一二兩三四五六七八九十百千萬多好幾次上]*架|[你妳汝我咱俺他她它祂誰其])|[一這那]?[點些麼]|的話|[\\\\]|[\s　]|$)' => '$1做$2',
        '(?<!^|[\3]|[\s　]|[能對]|[是])幹的$' => '做的',
        ...
        '死([干乾幹做])[活事]([干乾幹做])' => '死幹活幹',
        // replace 活 - 事
        '([的些點有]|[日天周週月年]|小?時|[秒分]鐘|[什甚]麼)活([阿啊吧呢嗎囉哩嘞吶呀嘎唷喲耶]|[也還]|[\\\\]|[\s　]|$)' => '$1事$2',
        // restore protections
        '_protect_Huo_' => '活',
        '_protect_XinGanXian_' => '幹線',
        '_protect_([^_])*_Gan_' => '$1幹',
    ];
