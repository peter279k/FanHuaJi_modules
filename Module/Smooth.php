...
class Smooth extends AbstractModule {
    ...
    private static $mapping = [
        ...
        '((?<![父母])親|(?<![反應上])對|(?<![作])用|(?<![意])識|(?<![偵])探|警[告示惕]|[疼關照]愛|[谷穀][歌哥]|[處懲]罰|[招期]待|參觀|[交轉變]換|[湊配磨]合|冷靜|稍微?等|整理|注意|收斂|尊重|享受|想像|過來|努力|解釋|準備|休息|調整|反省|持續|堅持|關照|介紹|檢查|改變|催眠|感受|努力|[放輕]鬆|[摸握找叫嘗嚐試認搭借演示範說明問去查看睡聽想做作了正幫思考慮弄露開敷擾])([你妳您汝咱俺余我他她它牠祂誰們]*)下(?![\d一二兩三四五六七八九十]|[述降落等級屬令來去方面層巴載落水雨雪酒午蛋遊游流節達行腹廚列場僕劃回卷山半注毒跪界樓床賤定決著滑車限]|[^這那]{1,3}機|[下一]?([個周週次屆集回任]|[^\s　]{0,5}棋)|回[來去家程]|體(?![育溫])|手[的得地]|坡(?![度])|文(?![章內稿])|學[期年]|命令|黃泉|地獄|江山|水道|星期|禮拜|下[籤策]|[樑梁]歪|三[濫爛])'=>'$1$2一下',
