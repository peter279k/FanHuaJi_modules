...
// 帶上
'帶上(?=[來去]|.{1,3}[車機船])' => '_protect_DaiShang_', // protect "帶上"
'門帶上' => '門關上',
'帶上([這那][個種點些])' => '帶著$1',
