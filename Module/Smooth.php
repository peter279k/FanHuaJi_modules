...
class Smooth extends AbstractModule {
    ...
    private static $mapping = [
        ...
        '((?<![父母])親|(?<![反應上])對|(?<![作])用|(?<![意])識|(?<![偵])探|警[告示惕]|[疼關照]愛|[谷穀][歌哥]|[處懲]罰|[招期]待|參觀|[交轉]換|[湊配磨]合|冷靜|稍微?等|整理|注意|收斂|尊重|享受|想像|過來|努力|反省|持續|堅持|關照|檢查|改變|催眠|努力|[放輕]鬆|[打摸握找叫嘗嚐試認搭借演示範說明問去查看睡聽想做作了正幫思考慮弄露拿])([你妳您汝咱俺余我他她它牠祂誰們]*)下(?![述降落等級屬令來去方面層巴載落水雨雪酒午蛋遊游流節達行腹廚列場僕劃回卷山半注毒跪界樓床賤定決著滑車]|[^這那]{1,3}機|[下一]?([個周週次屆集回任]|[^\s　]{0,5}棋)|回[來去家程]|體(?![育溫])|手[的得地]|坡(?![度])|文(?![章內稿])|學[期年]|命令|黃泉|地獄|江山|水道|星期|禮拜|下[籤策]|[樑梁]歪|三[濫爛])'=>'$1$2一下',
        ...
        '([打看聽說喝送]|發現|告訴)((?:[你妳您汝咱俺余我他她它牠祂誰們]|[了到])*)個(?![鬼屁毛屌]|[子體頭性人案戶夠爽賭好安盹底信茶話啵]|[\d一二兩三四五六七八九十幾]*折|措手|沒完|不[停斷可能行]|痛快|音樂|影片|電[話視腦影]|[^\s　]{0,2}結(?![果束局])|瞌睡|招呼|清楚|仔細|噴嚏|東西|正著|商量|平手一?杯)'=>'$1$2一個',
